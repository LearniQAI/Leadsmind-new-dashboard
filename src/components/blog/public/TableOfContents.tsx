...
export const TableOfContents: React.FC<TableOfContentsProps> = ({ headings }) => {
  ...
  return (
    <div className="hidden lg:block sticky top-28 w-60 h-fit space-y-4 self-start bg-white border border-[#E2E8F0] shadow-sm p-5 rounded-2xl">
      <div className="flex items-center gap-2 border-b border-[#F1F5F9] pb-2">
        <BookOpen className="w-4 h-4 text-primary" />
        <span className="text-[10px] font-bold uppercase tracking-wider text-[#0F172A]">Table of Contents</span>
      </div>
