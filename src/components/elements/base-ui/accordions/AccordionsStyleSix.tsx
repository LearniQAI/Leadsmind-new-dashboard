  ...
  return (
    <>
      ...
      <div className="card__title-wrap mb-[20px]">
        <h5 className="card__heading-title">Accordions Style 06</h5>
      </div>
      <div className='accordion-body accordion-circle-style'>
      <MuiAccordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <MuiAccordionSummary
          ...
          id="panel1d-header"
        >
          <Typography className='accordion-header'> <span>Q1:</span> Accordion Item #1</Typography>
        </MuiAccordionSummary>
        <MuiAccordionDetails>
      ...
      <MuiAccordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <MuiAccordionSummary
          ...
          id="panel2d-header"
        >
          <Typography className='accordion-header'> <span>Q2:</span> Accordion Item #2</Typography>
        </MuiAccordionSummary>
        <MuiAccordionDetails>
          <div className="accordion-body">
            <strong>This is the first {`item's`} accordion body.</strong> It is shown by
      ...
      <MuiAccordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <MuiAccordionSummary
          ...
          id="panel3d-header"
        >
          <Typography className='accordion-header'><span>Q3:</span> Accordion Item #3</Typography>
        </MuiAccordionSummary>
        <MuiAccordionDetails>
          <div className="accordion-body">
            <strong>This is the first {`item's`} accordion body.</strong> It is shown by
...
export default AccordionsStyleSix;
