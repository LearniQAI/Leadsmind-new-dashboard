  ...
  return (
    <>
      ...
      <div className="card__title-wrap mb-[20px]">
        <h5 className="card__heading-title">Accordions Style 04</h5>
      </div>
      <div className='accordion-body accordion-primary-light'>
...
export default AccordionStyleFour;
