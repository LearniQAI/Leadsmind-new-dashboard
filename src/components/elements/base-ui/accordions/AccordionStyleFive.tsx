  ...
  return (
    <>
      ...
      <div className="card__title-wrap mb-[20px]">
        <h5 className="card__heading-title">Accordions Style 05</h5>
      </div>
      <div className='accordion-body accordion-border-primary accordions-items-separate'>
...
export default AccordionStyleFive;
