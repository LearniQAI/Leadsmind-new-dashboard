...
const VerticalTextSteps = () => {
  const [currentStep, setCurrentStep] = useState(1);
  return (
    <>
      <div className="card__wrapper">
        <div className="card__title-wrap mb-[20px]">
          <h5 className="card__heading-title">Vertical Text Steps</h5>
        </div>
        <div className="steps__form">
          <div className="steps__row style_two setup-panel-3">
            <div className="steps__step style_two">
              <Link href="#" 
...
export default VerticalTextSteps;
