...
import TimelineChartsBasic from './TimelineChartsBasic';
import CustomDropdown from '@/components/dropdown/CustomDropdown';
import { dropdownItems } from '@/data/dropdown-data';
import TimelineDistributed from './TimelineDistributed';
import TimelineChartAdvanced from './TimelineChartAdvanced';
import TimelineChartMultipleSeries from './TimelineChartMultipleSeries';

const ApexChartTimelineMainArea = () => {
  return (
    <>
      {/* -- App side area start -- */}
          ...
          <div className="col-span-12">
            <div className="card__wrapper style_two">
              <div className="card__title-wrap flex items-center justify-between mb-[25px]">
                <h5 className="card__heading-title">Timeline Charts</h5>
              </div>
...
export default ApexChartTimelineMainArea;
