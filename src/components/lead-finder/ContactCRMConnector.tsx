      ...
      {pipelineId ? (
        <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs !text-dash-textMuted">Active in Pipeline Opportunity</p>
          </div>
        </div>
      ) : (
        <div className="space-y-3">
          <p className="text-sm !text-dash-textMuted">This contact is currently isolated. Push to pipeline to manage outreach and opportunities.</p>
          <button
            onClick={handlePush}
            disabled={loading}
