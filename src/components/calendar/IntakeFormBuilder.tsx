    ...
    <div className="card__wrapper border-primary/10 mt-[20px]">
      <div className="card__title-wrap flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
           ...
           <h5 className="card__heading-title uppercase italic">Intake Protocol</h5>
           <p className="card__desc style_two text-sm italic font-medium mt-2">Design the dynamic data payload for each booking.</p>
        </div>
        <div className="flex gap-3">
           <Button 
             onClick={addField} 
             variant="outline"
             className="bg-card dark:bg-card-dark border-border dark:border-border-dark text-heading dark:text-heading-dark rounded-xl gap-2 font-bold uppercase italic text-[10px] h-12 px-6 hover:bg-primary/5 transition-all"
           >
          ...
          <div key={field.id} className="flex flex-col md:flex-row items-start md:items-center gap-4 p-5 rounded-xl bg-bgBody dark:bg-bgBody-dark border border-border dark:border-border-dark group hover:border-primary/30 transition-all duration-500">
             ...
             <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                <Input 
                   ...
                   className="bg-card dark:bg-card-dark border-border dark:border-border-dark text-heading dark:text-heading-dark rounded-lg h-11 text-sm italic font-medium"
                ...
                <div className="flex gap-2">
                   <select 
                      ...
                      className="flex-1 bg-card dark:bg-card-dark border border-border dark:border-border-dark text-heading dark:text-heading-dark rounded-lg h-11 px-4 text-[10px] font-black uppercase tracking-widest italic outline-none focus:ring-1 focus:ring-primary/50 transition-all"
                   >
                   ...
                   >
                      <span className="text-[9px] font-black uppercase italic tracking-widest">Req</span>
                   </Button>
                   <Button 
                      variant="ghost" 
