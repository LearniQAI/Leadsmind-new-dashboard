    ...
    <div className="card__wrapper border-primary/10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div className="card__title-wrap">
           ...
           <h5 className="card__heading-title uppercase italic">Routing Targets</h5>
           <p className="card__desc style_two text-sm italic font-medium mt-2">Map meeting goals to automated team workflows.</p>
        </div>
        <Button 
        ...
        {outcomes.map((outcome) => (
          <div key={outcome.id} className="group p-6 rounded-xl bg-bgBody dark:bg-bgBody-dark border border-border dark:border-border-dark hover:border-primary/40 transition-all duration-500 relative overflow-hidden">
             ...
             <div className="flex items-center justify-between mb-6 relative z-10">
                <span className="text-base font-black text-heading dark:text-heading-dark group-hover:text-primary transition-colors uppercase italic">{outcome.label}</span>
          ...
          <div className="p-6 rounded-xl bg-primary/5 border border-primary/20 animate-in zoom-in duration-500">
             <div className="space-y-6">
                ...
                <div className="flex gap-3">
                   <Button onClick={handleAdd} className="flex-1 bg-primary text-white rounded-lg h-10 font-bold italic uppercase text-[10px]">
