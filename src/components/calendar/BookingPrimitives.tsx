  ...
  return (
    <div className="card__title-wrap flex flex-col gap-1 mb-[20px]">
      ...
      <div className="flex items-center justify-between gap-4">
        <h5 className="card__heading-title mb-0 uppercase italic">
          {title}
        </h5>
        {badge}
      </div>
      {description && <p className="card__desc style_two text-xs font-medium mt-3 leading-relaxed italic">{description}</p>}
    </div>
  );
}
