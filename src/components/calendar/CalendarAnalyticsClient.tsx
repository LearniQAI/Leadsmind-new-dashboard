            ...
            <div className="col-span-12 mb-[25px]">
               <div className="card__wrapper style_two !mb-0 !p-0">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                     <div>
                        <h4 className="card__title mb-1 uppercase italic tracking-tighter">Scheduling Dynamics</h4>
                          ...
                          <div key={day} className="group cursor-default">
                            <div className="flex justify-between items-end mb-2">
                               ...
                               <div className="flex items-center gap-2">
                                  <span className="text-base font-black text-heading dark:text-heading-dark italic tracking-tighter">{count}</span>
                                  <span className="text-[9px] font-bold text-placeholder dark:text-placeholder-dark uppercase italic">Events</span>
                               </div>
                            </div>
               ...
               <div className="card__wrapper h-full">
                  ...
                  <div className="mt-10 p-6 rounded-2xl bg-primary/5 border border-primary/10 relative overflow-hidden group">
                     ...
                     <div className="relative z-10">
                        ...
                        <p className="text-[12px] font-medium text-body dark:text-body-dark italic leading-relaxed">
...
function KPICard({ title, value, percentage, isIncrease, iconClass, description }: any) {
  return (
    <div className="card__wrapper">
       ...
       <h4 className="card__title mb-[10px] italic font-black tracking-tighter">{value}</h4>
  ...
  return (
    <div className="flex items-center justify-between p-4 rounded-xl bg-bgBody dark:bg-bgBody-dark border border-border dark:border-border-dark hover:border-primary/30 transition-all group cursor-default">
       <div className="flex items-center gap-4">
          ...
          <span className="text-xs font-black text-body dark:text-body-dark opacity-60 uppercase italic tracking-tight group-hover:opacity-100 transition-opacity">{label}</span>
       </div>
       <span className="text-sm font-black text-heading dark:text-heading-dark italic tracking-tighter">{value}</span>
    </div>
  )
}
