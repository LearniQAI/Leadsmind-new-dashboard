                  ...
                  <div className="card__wrapper !p-4 !mb-0 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl no-print">
                     <div className="flex items-center gap-4">
                        ...
                        <div className="overflow-hidden">
                           <h3 className="card__title !text-lg !mb-0 italic truncate">Quote Details</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 md:mb-20 relative z-10">
                           ...
                           <div className="grid grid-cols-2 gap-4 pt-0 md:pt-6">
                              <div>
                                 ...
                                 <span className="text-sm font-black italic text-white whitespace-nowrap">{format(new Date(selectedProposal.created_at), 'dd MMM yyyy')}</span>
                              </div>
                              <div>
                                 <span className="text-[8px] font-black uppercase tracking-[0.2em] text-white/30 block mb-2">Validity Limit</span>
                                 <span className="text-sm font-black italic text-primary whitespace-nowrap">{selectedProposal.valid_until ? format(new Date(selectedProposal.valid_until), 'dd MMM y') : 'N/A'}</span>
                              </div>
                           </div>
                        </div>
                              ...
                              <tbody className="divide-y divide-white/5">
                                 ...
                                 {(!selectedProposal.items || selectedProposal.items.length === 0) && (
                                    <tr className="group/row">
                                       <td className="py-10 font-black italic uppercase text-sm text-white/90 group-hover/row:text-primary transition-colors">Strategic Services Package</td>
                                       ...
                                       <td className="py-10 text-right font-black italic text-white text-2xl">${Number(selectedProposal.total_amount).toLocaleString()}</td>
                                    </tr>
                                 )}
                              </tbody>
                           </table>
                        ...
                        <div className="flex justify-end pt-12 border-t-2 border-white/10 relative z-10">
                           <div className="w-full md:w-80 space-y-6">
                              ...
                              <div className="flex justify-between items-center pt-6">
                                 ...
                                 <span className="text-4xl md:text-6xl font-black italic tracking-tighter text-white">${Number(selectedProposal.total_amount).toLocaleString()}</span>
                              </div>
                           </div>
                        </div>
