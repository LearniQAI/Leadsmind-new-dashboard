        ...
        <div className="col-span-12 lg:col-span-4 xxl:col-span-3">
          ...
          <div className="card__wrapper sticky top-28">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-black text-white mb-1 uppercase tracking-tighter italic">
              ...
              <div className="w-full bg-white/[0.02] border border-white/5 rounded-2xl p-5 mb-8 group hover:border-primary/20 transition-all">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`text-2xl font-black italic tracking-tighter ${(contact.lead_score || 0) > 75 ? 'text-success' :
                ...
                {contact.lead_score_explanation && (
                  <p className="text-[10px] text-white/40 leading-relaxed italic text-left border-l-2 border-primary/20 pl-4 py-1">
                    "{contact.lead_score_explanation}"
                  </p>
                )}
              </div>
            ...
            <div className="space-y-6 pt-6 border-t border-white/5">
              ...
              <div className="pt-6 border-t border-white/5 space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {(!contact.tags || contact.tags.length === 0) && !isAddingTag && <span className="text-[10px] text-white/10 uppercase font-black tracking-widest italic">No tags</span>}
                </div>
              </div>
            </div>
          </div>
