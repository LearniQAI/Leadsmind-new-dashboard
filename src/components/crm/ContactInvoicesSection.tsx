    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card__wrapper no-height">
          ...
          <p className="text-2xl font-black text-white italic tracking-tighter">${totalInvoiced.toLocaleString()}</p>
        </div>
        <div className="card__wrapper no-height">
          <p className="text-[9px] font-black uppercase tracking-[0.2em] text-white/20 mb-2">Total Paid</p>
          <div className="flex items-center gap-2">
            <p className="text-2xl font-black text-success italic tracking-tighter">${totalPaid.toLocaleString()}</p>
        ...
        <div className="card__wrapper no-height bg-primary/5 border-primary/20">
          ...
          <p className="text-2xl font-black text-white italic tracking-tighter">${balance.toLocaleString()}</p>
        </div>
      </div>
                ...
                invoices.map((inv) => (
                  <div key={inv.id} className="p-6 flex items-center justify-between hover:bg-white/[0.01] transition-all group">
                    ...
                    <div className="text-right flex items-center gap-6">
                      <div>
                        <p className="text-base font-black text-white italic tracking-tighter">${inv.total_amount.toLocaleString()}</p>
