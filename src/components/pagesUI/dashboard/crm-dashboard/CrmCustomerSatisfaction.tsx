...
import SatisfactionProgressbar from "../../apps/home/SatisfactionProgressbar";

const CrmCustomerSatisfaction = () => {
          ...
          <div className="card__meta-box flex items-center gap-[10px] sm:gap-[20px] mb-[25px]">
           ...
           <span className="card__desc style_two">
            <span className="price-increase">
             <i className="fa-light fa-arrow-up"></i> +17.5%
            </span>{" "}
            Than Last Week
           </span>
          </div>
...
export default CrmCustomerSatisfaction;
