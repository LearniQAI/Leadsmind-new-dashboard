...
export const STEP_TYPE_META: Record<StepType, StepTypeMeta> = {
  opt_in: { businessGoal: 'Opt-in', label: 'Opt-in Page', icon: UserPlus, defaultTemplateId: 'blank-slate' },
  opt_in_thank_you: { businessGoal: 'Opt-in', label: 'Opt-in Thank-you', icon: CheckCircle, defaultTemplateId: 'blank-slate' },
  sales_page: { businessGoal: 'Sales', label: 'Sales Page', icon: ShoppingCart, defaultTemplateId: 'education-lms' },
