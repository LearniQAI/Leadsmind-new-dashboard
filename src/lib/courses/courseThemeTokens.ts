...
//     ROUNDED SANS (Sora), not a serif; its accent (#FF6B1A) is a fully-saturated vivid
//     orange (brightened from the original burnt-amber #D9622B, which read as brown in a real
//     browser check) — unmistakably "orange," not the clichéd clay terracotta #D97757. Grove is the one with a serif
...
export const COURSE_THEMES: Record<CourseThemeId, CourseThemeTokens> = {
  ...
  clean_minimal: {
    ...
    pageErrorHex: '#C0392B',
    gradientClass: 'from-[#FF6B1A] to-[#FF9A4D]',
    solidBgClass: 'bg-[#FF6B1A]',
    solidHoverBgClass: 'hover:bg-[#E85D0F]',
    textAccentClass: 'text-[#FF8A4C]',
    borderAccentClass: 'border-[#FF6B1A]',
  ...
  bold_feature_rich: {
    ...
    pageErrorHex: '#B3261E',
    gradientClass: 'from-[#FF1E3C] to-[#C4142C]',
    solidBgClass: 'bg-[#FF1E3C]',
    solidHoverBgClass: 'hover:bg-[#E01732]',
    textAccentClass: 'text-[#FF5A72]',
    borderAccentClass: 'border-[#FF1E3C]',
  ...
  community_coaching: {
    ...
    pageSuccessHex: '#16A34A',
    pageErrorHex: '#B33B2E',
    gradientClass: 'from-[#16A34A] to-[#3BCB73]',
    solidBgClass: 'bg-[#16A34A]',
    solidHoverBgClass: 'hover:bg-[#15803D]',
    textAccentClass: 'text-[#3BD07A]',
    borderAccentClass: 'border-[#16A34A]',
