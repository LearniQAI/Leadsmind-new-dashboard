     ...
     <div className="app__slide-wrapper">
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
       <div className="card__wrapper py-24 text-center max-w-xl border border-dashed border-border dark:border-border-dark">
        ...
        <h4 className="card__heading-title uppercase mb-4">No Waitlist Protocols Active</h4>
        <p className="text-body dark:text-body-dark opacity-60 font-medium text-sm leading-relaxed mb-10 px-10">
         You haven't configured any group sessions with waitlisting enabled. Dynamic attendee promotion is disabled.
        </p>
        <Button asChild className="bg-primary hover:bg-primary-dark text-white rounded-xl font-bold uppercase h-14 px-10 shadow-lg shadow-primary/20">
      ...
      <div className="col-span-12 mb-[20px]">
       <div className="card__wrapper bg-primary/5 border border-primary/10 relative overflow-hidden">
        ...
        <div className="relative z-10">
         ...
         <p className="text-body dark:text-body-dark opacity-70 text-sm font-medium mt-4 max-w-2xl leading-relaxed">
