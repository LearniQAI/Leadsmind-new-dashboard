       ...
       <div className="card__wrapper relative overflow-hidden bg-primary/5 border-primary/10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 relative z-10">
         <div className="flex-1">
          ...
          <h2 className="text-5xl font-black tracking-tighter text-heading dark:text-heading-dark uppercase leading-none mb-4">
           Calendar <span className="text-primary">Intelligence</span>
          </h2>
          <p className="text-body dark:text-body-dark opacity-70 text-sm font-medium max-w-2xl leading-relaxed">
         ...
         <div className="flex flex-col sm:flex-row gap-3">
          <Button asChild variant="outline" className="bg-card dark:bg-card-dark border-border dark:border-border-dark text-heading dark:text-heading-dark rounded-xl font-bold uppercase text-[10px] h-12 px-6 hover:bg-primary/5 transition-all">
           <Link href="/calendar/waitlist">
            <Users className="h-3.5 w-3.5 mr-2" />
            Waitlist Control
           </Link>
          </Button>
          <Button asChild className="bg-primary hover:bg-primary-dark text-white rounded-xl font-bold uppercase text-[10px] h-12 px-8 shadow-lg shadow-primary/20">
      ...
      {activeCalendar ? (
          ...
          <div className="space-y-[20px]">
           ...
           <div className="card__wrapper bg-primary/5 border border-primary/20 relative overflow-hidden group shadow-none">
            <div className="relative z-10">
              ...
              <h4 className="text-3xl font-black text-heading dark:text-heading-dark uppercase tracking-tighter mb-4 leading-none">Autonomous <br/> Optimization</h4>
              <p className="text-body dark:text-body-dark opacity-70 text-sm leading-relaxed mb-8 font-medium">
              ...
              <Button className="w-full bg-primary text-white hover:bg-primary-dark rounded-xl font-bold uppercase h-14 text-[10px] shadow-lg shadow-primary/20 transition-transform hover:scale-[1.02]">
               Apply Auto-Schedule
              </Button>
            </div>
       ...
       <div className="col-span-12">
        <div className="card__wrapper py-24 text-center border border-dashed border-border dark:border-border-dark">
         ...
         <h5 className="card__heading-title uppercase mb-2">No Active Nodes</h5>
         <p className="text-placeholder dark:text-placeholder-dark text-xs max-w-sm mx-auto">Deploy your first scheduling engine to unlock advanced intelligence routing and revenue logic.</p>
        </div>
       </div>
      )}
     </div>
