...
const ACTIONS: Record<string, (...args: any[]) => Promise<any>> = {
  ...
  getFormAnalyticsData: marketing.getFormAnalyticsData,
  getFormVariantsData: marketing.getFormVariantsData,
  createFormVariant: marketing.createFormVariant,
  updateFormVariantWeight: marketing.updateFormVariantWeight,
  archiveFormVariant: marketing.archiveFormVariant,
