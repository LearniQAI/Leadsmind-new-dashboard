        ...
        {initialCampaigns.length === 0 ? (
          ...
          initialCampaigns.map(campaign => (
            <div key={campaign.id} className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 group hover:border-primary/50 transition-all duration-500 shadow-xl shadow-black/40">
              ...
              <div className="mb-8">
                <h4 className="text-xl font-black text-white uppercase italic tracking-tighter mb-1 group-hover:text-primary transition-colors">{campaign.name}</h4>
                <p className="text-white/30 text-[10px] font-bold tracking-widest uppercase">Template: <span className="text-white/60 italic">{campaign.template?.name || 'Manual Build'}</span></p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                ...
                <div className="p-3 bg-white/5 rounded-xl border border-white/5 text-center">
                  ...
                  <span className="text-sm font-black text-white italic">0.0%</span>
                </div>
              </div>
