...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dash-bg text-dash-text flex flex-col items-center justify-center p-6 font-body relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white border border-dash-border rounded-3xl p-8 shadow-xl relative">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-space-grotesk font-black uppercase tracking-tight text-dash-text mt-1.5">
            Passwordless <span className="text-primary">Access</span>
          </h2>
        ...
        {success ? (
          <div className="text-center space-y-4 bg-emerald-50 border border-emerald-200 rounded-2xl p-6">
            <div className="w-10 h-10 bg-emerald-100 border border-emerald-200 rounded-full flex items-center justify-center mx-auto text-emerald-600">
              ✓
            </div>
            ...
            <Button
              ...
              className="text-[10px] font-bold uppercase tracking-widest text-primary hover:bg-dash-surface w-full mt-2"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-dash-surface border border-dash-border rounded-2xl pl-11 pr-4 py-3 text-xs outline-none focus:border-primary text-dash-text font-mono"
                  required
                  disabled={isPending}
                />
              </div>
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="w-full bg-primary hover:bg-primary/95 text-white rounded-2xl uppercase tracking-wider text-[10px] font-black h-12 shadow-sm flex items-center justify-center gap-1.5"
            >
              {isPending ? (
                <>
