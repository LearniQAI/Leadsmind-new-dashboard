...
export default function ModulesToolbar({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white border border-dash-border rounded-2xl p-4 shadow-sm">
      ...
      <div className="flex items-center bg-dash-surface border border-dash-border rounded-xl px-4 py-2 w-full md:max-w-xs focus-within:border-sky-500 transition-all motion-reduce:transition-none">
