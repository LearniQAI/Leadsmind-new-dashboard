...
export default function QuizBuilder({ quizId }: QuizBuilderProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-6 items-start">
      {/* Question Sidebar */}
      <div className="bg-[#111d47]/30 border border-white/5 p-4 rounded-xl space-y-4">
        ...
        <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
          {questions.map((q, idx) => (
            <div 
              ...
              className={`p-3 rounded-lg text-xs cursor-pointer select-none border transition-all flex items-center justify-between ${
          ...
          {questions.length === 0 && (
            <span className="text-[10.5px] italic text-white/30 block text-center py-4">No questions created yet.</span>
          )}
        </div>
      </div>

      {/* Editor Workbench */}
      <div className="bg-[#0c1535] border border-white/5 rounded-2xl p-6 space-y-5">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <select 
              ...
              className="w-full bg-[#111d47] border border-white/10 rounded-xl px-3 py-2 text-xs text-white focus:border-primary outline-none"
            >
          ...
          <div className="space-y-1">
            ...
            <input 
              ...
              className="w-full bg-[#111d47] border border-white/10 rounded-xl px-3 py-2 text-xs text-white outline-none"
            />
          </div>
        </div>
