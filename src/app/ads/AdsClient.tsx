 ...
 return (
  <div className="space-y-8">
   <div className="flex items-center justify-between">
    <div>
     <h1 className="text-4xl font-black uppercase tracking-tighter text-white leading-none">Ad <span className="text-primary">Command</span></h1>
     <p className="text-white/40 text-sm font-medium mt-2">Precision ad tracking and neural budget optimization.</p>
    </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 shadow-xl relative overflow-hidden group">
     ...
     <div className="relative z-10">
      ...
      <div className="flex items-end gap-2">
       <span className="text-3xl font-black text-white leading-none">${totalSpend.toLocaleString()}</span>
    ...
    <div className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 shadow-xl relative overflow-hidden group">
     ...
     <div className="relative z-10">
      ...
      <div className="flex items-end gap-2">
       <span className="text-3xl font-black text-white leading-none">{initialCampaigns.length}</span>
    ...
    <div className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 shadow-xl relative overflow-hidden group">
     ...
     <div className="relative z-10">
      ...
      <div className="flex items-end gap-2">
       <span className="text-3xl font-black text-white leading-none">3.8x</span>
   ...
   <div className="bg-[#0b0b1a] border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
    <div className="p-6 border-b border-white/10 flex items-center justify-between bg-white/5">
     <h3 className="text-sm font-black uppercase tracking-widest text-white">Active Campaigns</h3>
     ...
     <table className="w-full text-left border-collapse">
      ...
      <tbody className="divide-y divide-white/5">
       {initialCampaigns.length === 0 ? (
        <tr>
         <td colSpan={5} className="px-6 py-12 text-center text-white/20 font-bold uppercase tracking-widest">No active ad nodes detected</td>
        </tr>
       ) : (
        initialCampaigns.map(campaign => (
         <tr key={campaign.id} className="hover:bg-white/5 transition-colors">
          <td className="px-6 py-4 font-bold text-white">{campaign.name}</td>
