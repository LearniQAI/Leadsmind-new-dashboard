 ...
 return (
  <div className="space-y-8">
   <div className="flex items-center justify-between">
    <div>
     <h1 className="text-4xl font-black uppercase tracking-tighter text-white leading-none">Neural <span className="text-primary">Reputation</span></h1>
     <p className="text-white/40 text-sm font-medium mt-2">Monitor and dominate your industry's public perception.</p>
    </div>
    ...
    {initialReviews.length === 0 ? (
     ...
     initialReviews.map(review => (
      <div key={review.id} className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 group hover:border-primary/50 transition-all duration-500 shadow-xl shadow-black/40">
       ...
       <p className="text-sm text-white/60 leading-relaxed line-clamp-4 mb-6">"{review.body}"</p>
