 ...
 return (
  <div className="space-y-8">
   <div className="flex items-center justify-between">
    <div>
     <h1 className="text-4xl font-black uppercase tracking-tighter text-white leading-none">Smart <span className="text-primary">Forms</span></h1>
     <p className="text-white/40 text-sm font-medium mt-2">Capture high-intent leads with neural data extraction.</p>
    </div>
    <Button 
    ...
    {initialForms.length === 0 ? (
     ...
     initialForms.map(form => (
      <div key={form.id} className="bg-[#0b0b1a] border border-white/10 rounded-3xl p-6 group hover:border-primary/50 transition-all duration-500 shadow-xl shadow-black/40">
       ...
       <div className="mb-8">
        <h4 className="text-xl font-black text-white uppercase tracking-tighter mb-1 group-hover:text-primary transition-colors">{form.name}</h4>
