...
export async function getMetaAuthUrl(targetPlatform?: string) {
	...
	const scope = 'pages_show_list,pages_messaging,pages_manage_metadata,pages_read_engagement,instagram_manage_messages,instagram_basic,whatsapp_business_messaging,whatsapp_business_management,business_management';
