        ...
        <Wrapper>
          <div className="flex flex-col h-[calc(100vh-200px)] items-center justify-center text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="card__title !text-3xl uppercase tracking-tight italic">No pipelines yet</h2>
          ...
          <div className="space-y-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between px-2">
              <div className="flex flex-wrap items-center gap-4">
                <div>
                  <h1 className="card__title !text-4xl uppercase italic mb-1">Pipelines</h1>
