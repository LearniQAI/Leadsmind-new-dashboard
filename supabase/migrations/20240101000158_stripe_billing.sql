-- 1. Update Workspaces table with Stripe fields
...
-- 2. Create Products table (for invoicing/selling items)
...
-- 3. Create Invoices table (for Stripe checkout of invoices)
...
-- Basic RLS Policies
DROP POLICY IF EXISTS "Workspace owners can manage products" ON public.products;
